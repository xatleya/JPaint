...
public class OvalDrawPanelListener implements MouseListener{
    ...
    public void mouseReleased(MouseEvent me) {
       ...
       if(xEnd < this.xOrigin && yEnd < this.yOrigin) {
           ...
           shapeForeground = new Ellipse2D.Float(xEnd+2,yEnd+2,this.xOrigin-xEnd-4,this.yOrigin-yEnd-4);
       }
       else if(yEnd < this.yOrigin) {
           shapeBackground = new Ellipse2D.Float(this.xOrigin,yEnd,xEnd-this.xOrigin,this.yOrigin-yEnd);
           shapeForeground = new Ellipse2D.Float(this.xOrigin+2,yEnd+2,xEnd-this.xOrigin-4,this.yOrigin-yEnd-4);
       }
       else if(xEnd < this.xOrigin) {
           shapeBackground = new Ellipse2D.Float(xEnd,this.yOrigin,this.xOrigin-xEnd,yEnd-this.yOrigin);
           shapeForeground = new Ellipse2D.Float(xEnd+2,this.yOrigin+2,this.xOrigin-xEnd-4,yEnd-this.yOrigin-4);
       }
       else{
           shapeBackground = new Ellipse2D.Float(this.xOrigin,this.yOrigin,me.getX()-this.xOrigin,me.getY()-this.yOrigin);
           shapeForeground = new Ellipse2D.Float(this.xOrigin+2,this.yOrigin+2,me.getX()-this.xOrigin-4,me.getY()-this.yOrigin-4);
       }
       ...
       MyShape ellipse = new MyShape(drawPanel.getModele(), shapeForeground, shapeBackground, foregroundColor, backgroundColor);
